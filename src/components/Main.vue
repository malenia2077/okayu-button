<template>
  <v-container>
    ...
    <v-row class="mt-5" align="center" justify="center">
      <div class="text-center display-1 font-weight-bold" @click="easter = !easter">{{ easter ? $t('ui.title_easter') : $t('ui.title') }}</div>
    </v-row>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            change_title() {
                if(this.title === this.$t('ui.title')) {
                    this.title = this.$t('ui.title_easter');
                }
            }
        },
        watch: {
